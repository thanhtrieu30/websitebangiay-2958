      ...
      <form onSubmit={handleSubmit}>
        ...
        <div>
          <label className="pb-2">
            Tên sản phẩm trong sự kiện này{" "}
        ...
        <div>
          ...
          <input
            ...
            placeholder="điền giá muốn bán ra thị trường..."
          />
        </div>
        <br />
        <div>
          ...
          <input
            ...
            placeholder="điền số lượng tồn..."
          />
        </div>
        <br />
        <div>
          <label className="pb-2">
            Ngày sự kiện bắt đầu <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
        ...
        <div>
          <label className="pb-2">
            Ngày sự kiện kết thúc <span className="text-red-500">*</span>
          </label>
          <input
            type="date"
            name="price"
